            ...
            <div class="container-fluid">            
                ...
                <div class="row">
                    <div class="list-group col-md-2">
                        <a id="ml-1" href="egresado/actualizaDatos" class="list-group-item menu-lateral"> Actualizar Datos Personales</a>
                        <a id="ml-2" href="egresado/actualizaDatosAcademicos" class="list-group-item menu-lateral">Actualizar Datos Académicos</a>
                        <a id="ml-3" href="egresado/actualizaDireccion" class="list-group-item menu-lateral">Actualizar Domicilio</a>
                        <a id="ml-4" href="#" class="list-group-item menu-lateral">Agregar Idiomas</a>
                        <a id="ml-5" href="#" class="list-group-item menu-lateral">Agregar Experiencia Laboral</a>
                        <a id="ml-6" href="#" class="list-group-item menu-lateral">Agregar Habilidades</a>
                    </div>
