<?php
/**
 * Class that operate on table 'egre_cat_roles'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreCatRolesOracleDAO implements EgreCatRolesDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreCatRolesOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreCatRolesOracle egreCatRole
 	 */
