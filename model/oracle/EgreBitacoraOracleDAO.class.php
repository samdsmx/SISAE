<?php
/**
 * Class that operate on table 'egre_bitacora'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreBitacoraOracleDAO implements EgreBitacoraDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreBitacoraOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreBitacoraOracle egreBitacora
 	 */
