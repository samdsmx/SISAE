<?php
/**
 * Class that operate on table 'egre_datos_acads_externos'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreDatosAcadsExternosOracleDAO implements EgreDatosAcadsExternosDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreDatosAcadsExternosOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreDatosAcadsExternosOracle egreDatosAcadsExterno
 	 */
