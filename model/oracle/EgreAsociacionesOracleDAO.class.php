<?php
/**
 * Class that operate on table 'egre_asociaciones'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreAsociacionesOracleDAO implements EgreAsociacionesDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreAsociacionesOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreAsociacionesOracle egreAsociacione
 	 */
