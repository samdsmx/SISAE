<?php
/**
 * Class that operate on table 'egre_cat_formas_titulacion'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreCatFormasTitulacionOracleDAO implements EgreCatFormasTitulacionDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreCatFormasTitulacionOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreCatFormasTitulacionOracle egreCatFormasTitulacion
 	 */
