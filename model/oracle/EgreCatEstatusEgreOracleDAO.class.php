<?php
/**
 * Class that operate on table 'egre_cat_estatus_egre'. Database Oracle.
 *
 * @author: http://phpdao.com
 * @date: 2015-09-09 23:54
 */
class EgreCatEstatusEgreOracleDAO implements EgreCatEstatusEgreDAO{

	/**
	 * Get Domain object by primry key
	 *
	 * @param String $id primary key
	 * @return EgreCatEstatusEgreOracle 
	 */
	...
	/**
 	 ...
 	 *
 	 * @param EgreCatEstatusEgreOracle egreCatEstatusEgre
 	 */
